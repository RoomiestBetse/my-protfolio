        ...
        <div>
          ...
          {services.map((s, i) => (
            <motion.div
              ...
              className="glow-row group grid grid-cols-[auto_1fr] md:grid-cols-[auto_1fr_2fr] items-center gap-6 md:gap-12 py-8 md:py-12 border-b border-border/40 hover:bg-foreground/[0.02] transition-colors px-2 md:px-4"
            >
              <motion.span
